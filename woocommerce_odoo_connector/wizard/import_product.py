...
class ImportWoocommerceProducts(models.TransientModel):
    ...
    def _get_product_basics(self, woocommerce, channel, product_data):
        ...
        description_short_web = remove_tags(product_data.get("short_description"))
        description_web = remove_tags(product_data.get("description"))
        vals = dict(
            name=name,
            ...
            height=height,
            weight=weight,
            description_short_web=description_short_web,
